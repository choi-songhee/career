export const ProjectList = [
  {
    ...
    desc: 'LG HOMIN 앱/웹의 기본적인 유지보수와 다양한 기획 요구에 맞는 UI 개선 및 이슈처리를 진행하였습니다' +
      '\n- 안심비대면 반려견 배상책임 보험 UI 개선 작업' +
      '\n- 안심비대면 APP용 이벤트 페이지 퍼블리싱 작업' +
      '\n- 주문서 UI 개선 작업' +
      '\n- 백오피스 UI 개선 및 이슈사항 처리 작업',
  ...
  },
  {
    ...
    desc: 'SK open api 플랫폼으로 react.js를 기반으로 하여 모바일, PC, 반응형으로 구축 작업을 진행하였습니다' +
      '\n- GSAP 라이브러리를 사용하여 스크롤 인터랙션 구현' +
      '\n- react hook을 사용하여 상태관리와 Dom Event 구현' +
      '\n- 재사용성을 고려하여 컴포넌트 설계 작업 진행',
    tech: 'React.js / Html / Scss / Javascript / Git / Zeplin'
  },
  {
    title: '삼성 SDS 인적자원 Visibility 내부 서비스 구축',
    period: '2021.07 - 2021.09',
    desc: '- Vue.js를 기반으로 한 삼성 SDS 인적자원 내부 서비스 구축 작업을 진행하였습니다' +
      '\n- Vue 컴포넌트 간 데이터와 이벤트 전달을 사용하여 UI 구성' +
      '\n- 기획 요구에 따른 기능추가 및 수정작업 진행' +
      '\n- 웹표준 및 웹 접근성, 크로스브라우징을 고려한 퍼블리싱 작업 진행',
  ...
  },
  {
    ...
    desc: 'LG 전자 플랫폼 운영 프로젝트로 유지보수 업무와 기획 요구에 따른 UI 개선 작업을 진행하였습니다' +
      '\n- AJAX를 사용하여 데이터 바인딩후 화면 렌더링',
    tech: 'Html / Scss / Javascript / Jquery / Git / Jira / Zeplin',
  ...
  },
  {
    ...
    desc: '삼성카드 약관 개선 프로젝트에 퍼블리싱 작업을 진행하였습니다' +
      '\n- 공통 가이드에 맞추어 공통화에 집중하여 약관 퍼블리싱 작업 진행',
  ...
  },
  {
    ...
    desc: 'Vue.js를 기반으로 하여 롯데 프리미엄몰 구축 작업을 진행하였습니다' +
      '\n- 프리미엄몰(현재 롯데백화점으로 변경) 화면 UI 구축' +
      '\n- Swiper 이벤트, vue-masonry 등 다양한 라이브러리를 사용하여 인터페이스 구현' +
      '\n- 시맨틱한 HTML 구조로 재사용을 고려한 컴포넌트 설계' +
      '\n- 컴포넌트의 props 값에 따른 조건부렌더링',
    tech: 'Vue.js / Html / Javascript / Scss / Git / Jira / Zeplin',
    url: 'https://www.lotteon.com/p/display/main/ellotte?mall_no=2'
  },
  {
    title: '비만 365mc 대구지사 웹사이트 구축',
  ...
  {
    title: '자사 프로젝트 웹사이트 구축 (GN글로벌 퍼블리싱팀)',
    period: '2019.04 - 2019.07',
    desc: '기업, 협회, 음식점 등 다양한 웹사이트를 웹/모바일/반응형에 맞게 html, css 및 간단한 스크립트 작업을 진행하였습니다',
