export const ProjectList = [
  ...
  },
  {
    ...
    desc: '- 기본적인 유지보수를 비롯해 다양한 기획 요구에 맞는 새로운 기능과 UI 개편 작업을 하였습니다. ' +
  ...
  {
    title: '비만 365mc 대구지점 웹사이트 구축',
    period: '2019.10 - 2019.11',
    desc: '비만 365mc 대구지점 소개 웹사이트로 웹표준 및 웹 접근성, 크로스브라우징을 고려한 반응형 퍼블리싱 작업을 진행하였습니다',
    tech: 'Html / Javascript / Scss'
  },
  {
    title: '라이나생명 전성기 영상명함 구축',
    period: '2019.09 - 2019.10',
    desc: '- 영상명함에 적용될 템플릿을 디자인 가이드에 맞춰 퍼블리싱하는 작업을 진행하였습니다',
